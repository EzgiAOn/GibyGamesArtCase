Shader "Giby Games/Slider Ramp/SliderRampSpecularRimNormal"
{
	Properties
	{
    ...
    [TCP2HeaderHelp(RIM, RIM)]
        ...
        _RimMin ("Rim Min", Range(0,1)) = 1.0
        _RimMax ("Rim Max", Range(0,5)) = 1.0
    [TCP2Separator]
	...
	SubShader
	{
		...
		#define IN_NORMAL s.Normal
            ...
            spec = smoothstep(0.5-_SpecSmooth*1, 1+_SpecSmooth*0.5, spec);
			spec *= atten;
			fixed4 c;
		...
		void surf(Input IN, inout SurfaceOutputCustom o)
		{
            ...
            half rim = 1.5f - saturate( dot(viewDir, o.Normal) );
